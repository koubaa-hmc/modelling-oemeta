# Contributing to oemeta-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
oemeta-schema. These guidelines are not strict rules.
...
The oemeta-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the oemeta-schema technical leads
...
[issues]: https://github.com/koubaa-hmc/oemeta-schema/issues/
[pulls]: https://github.com/koubaa-hmc/oemeta-schema/pulls/
